...
\maketitlepage{"Enhancements made to the digital twin applications"}
...
\begin{documentControl}
    \addVersion{0.1}{26.03.2025}{Buğrahan Zeynel Temür (TUM)}{Initial draft}
\end{documentControl}
...
[ONGOING]
Mechanics of the liver tissues encompasses several scales and results as the interplay of both fluid and solid phases.
