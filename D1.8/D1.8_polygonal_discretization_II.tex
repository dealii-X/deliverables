...
request \#19891. The Code Gallery example, multigrid demonstrator, and
...
First, the agglomeration-based Poisson program is publicly available
...
to the deal.II core library through pull request~\#19891. At the reporting date, the core pull request remains open and is awaiting maintainer review. Its eventual upstream integration is the next software step.
