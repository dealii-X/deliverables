...
The benchmark repository can be found at: \url{https://github.com/dealii-X/benchmarks/}
...
The benchmark kernels exploit algebraic sum factorization techniques to achieve an affordable evaluation in comparison to a naive sum algorithm. This type of technique has been popularized in recent years by several groups, including the deal.ii authors. 

The translation of these techniques to modern GPU architectures remains an open challenge at both software and hardware level. At the latter,  programmers are faced with a plethora of differeerms of achieving maximum effective utilizations, and the software level, where a multitude of 
