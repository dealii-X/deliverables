...
This report describes advances in co-design, technology exploitation and energy efficiency.
...
Kronbichler et al. \cite{kronbichler2023} have shown previously on an example of the conjugate gradient method, that above a certain problem size, the streaming operations contribute a significant chunk of the run-time.
