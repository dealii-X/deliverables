...
\begin{deliverableTable}
    \tableEntry{Abstract}{The report for D4.3 aims to provide a data management plan for the dealii-X project according to the European Commission guidelines. It presents the use of software and data in the project, the way results are structured to ensure its accessibility during the runtime of the project and beyond, and the resources devoted to achieve these goals.}
...
\begin{documentControl}
    \addVersion{0.1}{20.03.2025}{M. Kronbichler}{DPMOnline template}
    \addVersion{0.2}{21.03.2025}{M. Kronbichler, I. Prusak, R. Schussnig}{Initial draft}
    \addVersion{0.3}{26.03.2025}{M. Kronbichler, I. Prusak, R. Schussnig}{Partners' feedback collected}
    \addVersion{1.0}{28.03.2025}{M. Kronbichler, I. Prusak, R. Schussnig}{Final version}
\end{documentControl}
