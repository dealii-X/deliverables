...
\begin{figure}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{subnetwork-collapsed.png}
        \caption{a collapsed high-level node}
        \label{subnetwork-collapsed}
    \end{subfigure}\par\medskip
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{subnetwork-internal.png}
        \caption{the internal lower level definition of the subnetwork node
            shown in Fig.~\ref{subnetwork-collapsed}}
        \label{subnetwork-internal}
    \end{subfigure}
