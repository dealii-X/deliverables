...
\begin{deliverableTable}
    ...
    \tableEntry{Deliverable version}{0.4}
...
project, such as the brain mesh of Fig.~\ref{brain}, and on reference meshes
of several million cells used to characterize the performance of the editing
session.
...
to work without changes to the platform.
...
physical and numerical parameters. The same tool therefore takes part twice in
a single simulation, upstream, where tagging the mesh defines the geometry,
the materials and the boundaries of the problem to be solved, and downstream,
where the results are inspected once the run has completed;
Fig.~\ref{brain} shows the brain application at that second stage.
