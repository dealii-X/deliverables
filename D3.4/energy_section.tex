...
Measurements are driven by \texttt{p3em} \citep{Cielo25}, an open source approach to power, performance and energy measurement~\citep{pribec_wccm2026}.
...
It has been applied to a set of flagship science applications on SuperMUC-NG Phase~2, in a study presented at the IXPUG workshop of ISC~2026 which documents the methodology and its validation in more detail~\citep{supermucng_energy_2026}.
...
This way of presenting the trade-off follows the analysis of power capping and frequency scaling given by \cite{hager_wccm2026}.
...
For the BK1 mass operator we have measured the performance and the energy efficiency of the OpenMP, Kokkos and TinyTC implementations on a single device at its default operating point, shown in Figure~\ref{fig:intel_pvc_bk1_energy} and presented in preliminary form at the WCCM-ECCOMAS 2026 congress by \cite{pribec_wccm2026}.
