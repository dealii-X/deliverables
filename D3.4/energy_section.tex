...
Measurements are driven by \texttt{p3em} \cite{Cielo25}, an open source approach to power, performance and energy measurement~\cite{pribec_wccm2026}.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/dealii_bk1.png}
    \caption{
            Performance (GDoF/s) and energy efficiency (DoF updates per Joule) of the OpenMP, Kokkos and TinyTC implementations of the BK1 mass operator for degree $p = 2$ in 32-bit precision. The setup consists of 1000 billion elements per GPU tile (Intel Ponte Vecchio).
    }
