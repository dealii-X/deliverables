...
The implementation of the algorithms are available at \url{https://github.com/dealii-X/portable-multigrid}.

\subsection{Portable multigrid infrastructure in \texttt{deal.II}}

Developments of the portable multigrid infrastructure is gradually migrating to \texttt{deal.II}. Matrix-free geometric transfer operators were introduced in PR~\#19347\footnote{\url{https://github.com/dealii/dealii/pull/19347}, retrieved on 28.07.2026} (opened in February 2026 and merged in June 2026). This functionality was subsequently extended to support systems of finite elements in PR~\#20023\footnote{\url{https://github.com/dealii/dealii/pull/20023}, retrieved on 28.07.2026} (opened and merged in July 2026). Both pull requests are included in the upcoming \texttt{deal.II} release 9.8, scheduled for the coming weeks. Furthermore, PR~\#20023 has been successfully utilized in the new tutorial Step-104\footnote{\url{https://github.com/dealii/dealii/pull/20026}, retrieved on 28.07.2026}, demonstrating a substantial speedup of the transfer operators and boosting the overall solver speed by a factor of 3.
