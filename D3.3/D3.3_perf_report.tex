...
which is applicatable to a broad range or European supercomputing architectures,
thus supporting the transition to exascale computing platforms.
...
Being aware of the approaches and tools available, and adopting them early
in the software project development curve can yield significant benefits
for optimizing codebases across heterogeneous environments.
