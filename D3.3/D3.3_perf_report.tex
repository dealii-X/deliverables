...
\begin{itemize}
    \item DoF updates per second and
...
memory. Assuming the kernel is memory-bound, the effective BW measures how well the
kernels are implemented. Figs.~\ref{fig:BK1_GH200}, \ref{fig:BK1_PVC}, \ref{fig:BK1_AMD} show the results on Nvidia, Intel and AMD GPU systems for the BK1 kernel.
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{BK1_1}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{I_BK1_1}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{A_BK1_1}
